...
namespace Tc.DAL
{
    ...
    public partial class TcImage
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("ID", "TcImage");
        }
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from TcImage");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into TcImage(");
            strSql.Append("Fenleiid,Title,Jianyao,Tupian,Shipin,Url,Content,Click,AddUser,Addtime,Color,IsTuijian,IsTop,SeoTitle,SeoKeyword,SeoDescription)");
            ...
            parameters[2].Value = model.Jianyao;
            parameters[3].Value = model.Tupian;
            parameters[4].Value = model.Shipin;
            ...
            parameters[11].Value = model.IsTuijian;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update TcImage set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from TcImage ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,Fenleiid,Title,Jianyao,Tupian,Shipin,Url,Content,Click,AddUser,Addtime,Color,IsTuijian,IsTop,SeoTitle,SeoKeyword,SeoDescription from TcImage ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
            ...
            Tc.Model.TcImage model = new Tc.Model.TcImage();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Tc.Model.TcImage DataRowToModel(DataRow row)
        {
            Tc.Model.TcImage model = new Tc.Model.TcImage();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,Fenleiid,Title,Jianyao,Tupian,Shipin,Url,Content,Click,AddUser,Addtime,Color,IsTuijian,IsTop,SeoTitle,SeoKeyword,SeoDescription ");
            strSql.Append(" FROM TcImage ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,Fenleiid,Title,Jianyao,Tupian,Shipin,Url,Content,Click,AddUser,Addtime,Color,IsTuijian,IsTop,SeoTitle,SeoKeyword,SeoDescription ");
            strSql.Append(" FROM TcImage ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from TcImage T ");
