...
namespace Tc.Web.Admin.fengguang
{
    public partial class list :AdminBase
    {
        ...
        private void bind()
        {
            ...
            #endregion 设置条件
            var sumcount = 0;
            DataTable dt = BLL.BLLP.Instance.Get_Page_List("TcImage", "id desc", aspnetpage.StartRecordIndex, aspnetpage.PageSize, out sumcount);
        ...
        protected void lbtnDel_Click(object sender, EventArgs e)
        {
            ...
            if (lbtn != null)
            {
                ...
                BLL.TcImage.Instance.Delete(id);
                this.bind();//重新绑定
            }
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (strDels.Length > 0)
            {
                try
                {
                    BLL.TcImage.Instance.DeleteList(strDels);
