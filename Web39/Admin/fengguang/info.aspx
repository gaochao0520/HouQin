<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="info.aspx.cs" ValidateRequest="false" Inherits="Tc.Web.Admin.fengguang.info" %>
        ...
        <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td width="60%" height="30">
                    <img height="14" src="../images/book1.gif" width="20">&nbsp;<a href="list.aspx"><u>校园风光列表</u></a> &gt;&gt; 发布校园风格</td>
        ...
        <table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" id="needset" style="border: 1px solid #cfcfcf; background: #ffffff;">
            ...
            <tr>
                <td height="28" colspan="2" bgcolor="#F9FCEF" class="bline2">
                    <div style='float: left; line-height: 28px;'>&nbsp;<strong>图片描述内容：</strong></div>
                </td>
            </tr>
            <tr>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $("#uploadify").uploadify({
                ...
                uploader: '../handler/tupian.aspx?wh=<%=LibCache.get_theme_config("image_tp_wh")%>',
                queueID: 'fileQueue',
                auto: true,
                multi: false,
                buttonText: '上传图片',
